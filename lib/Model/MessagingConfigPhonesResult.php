...
/**
 * MessagingConfigPhonesResult Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class MessagingConfigPhonesResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagingConfigPhonesResult';
    ...
    */
     ...
     * Sets phones
     *
     * @param string[]|null $phones Phones assigned to the messaging config.
     *
     * @return self
     */
