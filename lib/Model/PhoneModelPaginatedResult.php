...
/**
 * PhoneModelPaginatedResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PhoneModelPaginatedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneModelPaginatedResult';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\PhoneModel[]',
        'search_id' => 'string'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\PhoneModel[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\PhoneModel[] $items items
     *
     * @return self
     */
