...
/**
 * V1PhonesPhoneVoicePutRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1PhonesPhoneVoicePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_Phones__phone__voice_put_request';
    ...
    */
     ...
     *
     * @param string|null $calls_forwarded_to calls_forwarded_to
     *
     * @return self
     */
    public function setCallsForwardedTo($calls_forwarded_to)
    {
        if (is_null($calls_forwarded_to)) {
            array_push($this->openAPINullablesSetToNull, 'calls_forwarded_to');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('calls_forwarded_to', $nullablesSetToNull);
            if ($index !== FALSE) {
