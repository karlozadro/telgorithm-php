...
/**
 * V1PhonesPostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1PhonesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_Phones_post_request';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling V1PhonesPostRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V1PhonesPostRequest., must be smaller than or equal to 64.');
        }
