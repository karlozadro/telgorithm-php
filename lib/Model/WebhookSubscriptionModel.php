...
/**
 * WebhookSubscriptionModel Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookSubscriptionModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookSubscriptionModel';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookSubscriptionModel., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookSubscriptionModel., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthorizationBearer($authorization_bearer)
    {
        ...
        if (!is_null($authorization_bearer) && (mb_strlen($authorization_bearer) > 256)) {
            throw new \InvalidArgumentException('invalid length for $authorization_bearer when calling WebhookSubscriptionModel., must be smaller than or equal to 256.');
        }
