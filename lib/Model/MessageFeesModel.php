...
/**
 * MessageFeesModel Class Doc Comment
 *
 * @category Class
 * @description Contains information on message processing fees.  There may be different platform fees per segment due to tiered pricing.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MessageFeesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessageFeesModel';
    ...
    protected static $openAPITypes = [
        'platform_fees' => '\OpenAPI\Client\Model\SegmentsGroupModel[]',
        'pass_through_fees' => '\OpenAPI\Client\Model\SegmentsGroupModel[]'
    ];
    ...
    protected static $setters = [
        ...
        'pass_through_fees' => 'setPassThroughFees'
    ];
    ...
    protected static $getters = [
        ...
        'pass_through_fees' => 'getPassThroughFees'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pass_through_fees', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets platform_fees
     *
     * @return \OpenAPI\Client\Model\SegmentsGroupModel[]|null
     */
     ...
     * Sets platform_fees
     *
     * @param \OpenAPI\Client\Model\SegmentsGroupModel[]|null $platform_fees Per-segment information on Telgorithm Platform fees.
     *
     * @return self
     */
    public function setPlatformFees($platform_fees)
    {
        if (is_null($platform_fees)) {
            array_push($this->openAPINullablesSetToNull, 'platform_fees');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('platform_fees', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets pass_through_fees
     *
     * @return \OpenAPI\Client\Model\SegmentsGroupModel[]|null
     */
    public function getPassThroughFees()
    {
        return $this->container['pass_through_fees'];
    }

    /**
     * Sets pass_through_fees
     *
     * @param \OpenAPI\Client\Model\SegmentsGroupModel[]|null $pass_through_fees Per-segment information on Telgorithm Pass-Through fees.
     *
     * @return self
     */
    public function setPassThroughFees($pass_through_fees)
    {
        if (is_null($pass_through_fees)) {
            array_push($this->openAPINullablesSetToNull, 'pass_through_fees');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('pass_through_fees', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['pass_through_fees'] = $pass_through_fees;
