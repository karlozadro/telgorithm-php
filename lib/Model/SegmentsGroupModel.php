...
/**
 * SegmentsGroupModel Class Doc Comment
 *
 * @category Class
 ...
 */
class SegmentsGroupModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SegmentsGroupModel';
    ...
    protected static $setters = [
        'fee_per_segment' => 'setFeePerSegment',
        'count' => 'setCount',
    ...
    protected static $getters = [
        'fee_per_segment' => 'getFeePerSegment',
        'count' => 'getCount',
    ...
    {
        $this->setIfExists('fee_per_segment', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets fee_per_segment
     *
     * @return float|null
     * @deprecated
     */
    public function getFeePerSegment()
    {
        return $this->container['fee_per_segment'];
    }

    /**
     * Sets fee_per_segment
     *
     * @param float|null $fee_per_segment Fee per segment.  This value is positive or zero.
     *
     * @return self
     * @deprecated
     */
    public function setFeePerSegment($fee_per_segment)
    {
        if (is_null($fee_per_segment)) {
            throw new \InvalidArgumentException('non-nullable fee_per_segment cannot be null');
        }
        $this->container['fee_per_segment'] = $fee_per_segment;
     ...
     * Sets count
     *
     * @param int|null $count Number of units (voice minutes, message segments, etc) in this group.
     *
     * @return self
     */
     ...
     * Sets fee_per_unit
     *
     * @param float|null $fee_per_unit Fee per one unit.  This value is positive or zero.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float|null $total Total fee for this group.  This value is positive or zero.
     *
     * @return self
     */
