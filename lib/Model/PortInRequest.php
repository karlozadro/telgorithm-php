...
/**
 * PortInRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PortInRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInRequest';
    ...
    protected static $openAPITypes = [
        'data' => '\OpenAPI\Client\Model\PortInRequestData',
        'files' => '\SplFileObject[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\PortInRequestData
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\PortInRequestData $data data
     *
     * @return self
     */
     ...
     * Sets files
     *
     * @param \SplFileObject[] $files LOA Files
     *
     * @return self
     */
    public function setFiles($files)
    {
        ...
        if ((count($files) < 1)) {
            throw new \InvalidArgumentException('invalid length for $files when calling PortInRequest., number of items must be greater than or equal to 1.');
        }
