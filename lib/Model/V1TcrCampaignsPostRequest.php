...
/**
 * V1TcrCampaignsPostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1TcrCampaignsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_TcrCampaigns_post_request';
    ...
    */
    ...
    public function setTcrCampaignId($tcr_campaign_id)
    {
        ...
        if ((mb_strlen($tcr_campaign_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tcr_campaign_id when calling V1TcrCampaignsPostRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTcrBrandId($tcr_brand_id)
    {
        ...
        if ((mb_strlen($tcr_brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tcr_brand_id when calling V1TcrCampaignsPostRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCreationDate($creation_date)
    {
        ...
        if (!is_null($creation_date) && (mb_strlen($creation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $creation_date when calling V1TcrCampaignsPostRequest., must be smaller than or equal to 10.');
        }
