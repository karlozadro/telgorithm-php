 ...
 *
 * @category Class
 * @description The list of the supported webhook types.&lt;p&gt;Possible values:&lt;/p&gt; &lt;ul&gt; &lt;li&gt;&lt;b&gt;TcrCampaignImported&lt;/b&gt;: Notifies that new campaign was imported from TCR.&lt;/li&gt; &lt;li&gt;&lt;b&gt;PhoneNumberStatusChanged&lt;/b&gt;: Notifies that phone number changed its status.&lt;/li&gt; &lt;li&gt;&lt;b&gt;InboundCallReceived&lt;/b&gt;: Inbound call received.&lt;/li&gt; &lt;li&gt;&lt;b&gt;InboundCallReceivedFallback&lt;/b&gt;: Inbound call received fallback.&lt;/li&gt; &lt;li&gt;&lt;b&gt;CallStatusChanged&lt;/b&gt;: Call status changed.&lt;/li&gt; &lt;/ul&gt;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class WebhookType
{
     ...
     */
    public const TCR_CAMPAIGN_IMPORTED = 'TcrCampaignImported';

    public const PHONE_NUMBER_STATUS_CHANGED = 'PhoneNumberStatusChanged';

    public const INBOUND_CALL_RECEIVED = 'InboundCallReceived';

    public const INBOUND_CALL_RECEIVED_FALLBACK = 'InboundCallReceivedFallback';

    public const CALL_STATUS_CHANGED = 'CallStatusChanged';
    ...
    {
        return [
            self::TCR_CAMPAIGN_IMPORTED,
            self::PHONE_NUMBER_STATUS_CHANGED,
            self::INBOUND_CALL_RECEIVED,
            self::INBOUND_CALL_RECEIVED_FALLBACK,
            self::CALL_STATUS_CHANGED
        ];
    }
}
