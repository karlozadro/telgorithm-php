...
/**
 * V1TcrCampaignsTcrCampaignIdPatchRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class V1TcrCampaignsTcrCampaignIdPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_TcrCampaigns__tcrCampaignId__patch_request';
    ...
    */
    ...
    public function setCreationDate($creation_date)
    {
        ...
        if (!is_null($creation_date) && (mb_strlen($creation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $creation_date when calling V1TcrCampaignsTcrCampaignIdPatchRequest., must be smaller than or equal to 10.');
        }
