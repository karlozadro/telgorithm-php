...
class CompanyModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'csp_id' => 'string',
        'csp_id_can_be_changed' => 'bool',
        'tcr_brand_sid' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'csp_id' => 'cspId',
        'csp_id_can_be_changed' => 'cspIdCanBeChanged',
        'tcr_brand_sid' => 'tcrBrandSid'
    ];
    ...
    protected static $setters = [
        'csp_id' => 'setCspId',
        'csp_id_can_be_changed' => 'setCspIdCanBeChanged',
        'tcr_brand_sid' => 'setTcrBrandSid'
    ];
    ...
    protected static $getters = [
        'csp_id' => 'getCspId',
        'csp_id_can_be_changed' => 'getCspIdCanBeChanged',
        'tcr_brand_sid' => 'getTcrBrandSid'
    ];
    ...
    {
        $this->setIfExists('csp_id', $data ?? [], null);
        $this->setIfExists('csp_id_can_be_changed', $data ?? [], null);
        $this->setIfExists('tcr_brand_sid', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets csp_id
     *
     * @param string|null $csp_id Campaign Service Provider Identifier in TCR (CspId).
     *
     * @return self
     */
    ...
    {
        if (is_null($csp_id)) {
            array_push($this->openAPINullablesSetToNull, 'csp_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('csp_id', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    /**
     * Gets csp_id_can_be_changed
     *
     * @return bool|null
     */
    public function getCspIdCanBeChanged()
    {
        return $this->container['csp_id_can_be_changed'];
    }

    /**
     * Sets csp_id_can_be_changed
     *
     * @param bool|null $csp_id_can_be_changed If `true`, the CSP ID can be changed. Otherwise, `false`.
     *
     * @return self
     */
    public function setCspIdCanBeChanged($csp_id_can_be_changed)
    {
        if (is_null($csp_id_can_be_changed)) {
            throw new \InvalidArgumentException('non-nullable csp_id_can_be_changed cannot be null');
        }
        $this->container['csp_id_can_be_changed'] = $csp_id_can_be_changed;
     ...
     * @return string|null
     */
    public function getTcrBrandSid()
    {
        return $this->container['tcr_brand_sid'];
    }

    /**
     * Sets tcr_brand_sid
     *
     * @param string|null $tcr_brand_sid Company TCR Brand Sid.
     *
     * @return self
     */
    public function setTcrBrandSid($tcr_brand_sid)
    {
        if (is_null($tcr_brand_sid)) {
            array_push($this->openAPINullablesSetToNull, 'tcr_brand_sid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tcr_brand_sid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tcr_brand_sid'] = $tcr_brand_sid;
