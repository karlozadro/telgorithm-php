...
/**
 * PortInData Class Doc Comment
 *
 * @category Class
 * @description PortIn data model.  See PortInData model.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PortInData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInData';
    ...
    */
    ...
    public function setPhones($phones)
    {
        ...
        if ((count($phones) > 100)) {
            throw new \InvalidArgumentException('invalid value for $phones when calling PortInData., number of items must be less than or equal to 100.');
        }
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling PortInData., number of items must be greater than or equal to 1.');
        }
