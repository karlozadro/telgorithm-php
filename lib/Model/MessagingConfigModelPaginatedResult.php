...
/**
 * MessagingConfigModelPaginatedResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MessagingConfigModelPaginatedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagingConfigModelPaginatedResult';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\MessagingConfigModel[]',
        'search_id' => 'string'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\MessagingConfigModel[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\MessagingConfigModel[] $items items
     *
     * @return self
     */
     ...
     * Sets search_id
     *
     * @param string|null $search_id search_id
     *
     * @return self
     */
    public function setSearchId($search_id)
    {
        if (is_null($search_id)) {
            array_push($this->openAPINullablesSetToNull, 'search_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('search_id', $nullablesSetToNull);
            if ($index !== FALSE) {
