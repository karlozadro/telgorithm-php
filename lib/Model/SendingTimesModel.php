...
/**
 * SendingTimesModel Class Doc Comment
 *
 * @category Class
 * @description Specifies the time zone and time periods in a day when the messaging should be active.  SMS and MMS won&#39;t be sent outside of these intervals.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SendingTimesModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendingTimesModel';
    ...
    */
    ...
    public function setTimeZoneId($time_zone_id)
    {
        ...
        if ((mb_strlen($time_zone_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_zone_id when calling SendingTimesModel., must be bigger than or equal to 1.');
        }
