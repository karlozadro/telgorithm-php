...
/**
 * V1OutboundMessagesPostRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class V1OutboundMessagesPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_OutboundMessages_post_request';
    ...
    */
    ...
    public function setFrom($from)
    {
        ...
        if ((mb_strlen($from) > 16)) {
            throw new \InvalidArgumentException('invalid length for $from when calling V1OutboundMessagesPostRequest., must be smaller than or equal to 16.');
        }
    ...
    public function setTo($to)
    {
        ...
        if ((mb_strlen($to) > 16)) {
            throw new \InvalidArgumentException('invalid length for $to when calling V1OutboundMessagesPostRequest., must be smaller than or equal to 16.');
        }
    ...
    public function setText($text)
    {
        ...
        if (!is_null($text) && (mb_strlen($text) > 8000)) {
            throw new \InvalidArgumentException('invalid length for $text when calling V1OutboundMessagesPostRequest., must be smaller than or equal to 8000.');
        }
