...
/**
 * V1TcrBrandsTcrBrandIdPutRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class V1TcrBrandsTcrBrandIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_TcrBrands__tcrBrandId__put_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V1TcrBrandsTcrBrandIdPutRequest., must be bigger than or equal to 1.');
        }
