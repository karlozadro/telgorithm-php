...
/**
 * PhoneListRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class PhoneListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhoneListRequest';
    ...
    */
    ...
    public function setPhones($phones)
    {
        ...
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling PhoneListRequest., number of items must be greater than or equal to 1.');
        }
