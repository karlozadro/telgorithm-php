...
/**
 * SetCompanyCspIdRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SetCompanyCspIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetCompanyCspIdRequest';
    ...
    */
    ...
    public function setCspId($csp_id)
    {
        ...
        if (!is_null($csp_id) && (!preg_match("/S[0-9A-Z]{6,127}/", $csp_id))) {
            throw new \InvalidArgumentException("invalid value for \$csp_id when calling SetCompanyCspIdRequest., must conform to the pattern /S[0-9A-Z]{6,127}/.");
        }
