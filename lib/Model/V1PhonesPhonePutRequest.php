...
/**
 * V1PhonesPhonePutRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1PhonesPhonePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_Phones__phone__put_request';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V1PhonesPhonePutRequest., must be smaller than or equal to 64.');
        }
