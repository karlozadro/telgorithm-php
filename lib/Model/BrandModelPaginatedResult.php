...
/**
 * BrandModelPaginatedResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BrandModelPaginatedResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandModelPaginatedResult';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\BrandModel[]',
        'search_id' => 'string'
    ];
    ...
    */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\BrandModel[] $items items
     *
     * @return self
     */
