...
/**
 * CreateOutboundMessageResult Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOutboundMessageResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOutboundMessageResult';
    ...
    */
    ...
    public function setSid($sid)
    {
        ...
        if ((mb_strlen($sid) > 128)) {
            throw new \InvalidArgumentException('invalid length for $sid when calling CreateOutboundMessageResult., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($sid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $sid when calling CreateOutboundMessageResult., must be bigger than or equal to 1.');
        }
     ...
     * Sets segment_count
     *
     * @param int $segment_count Number of text segments in the outbound message.
     *
     * @return self
     */
