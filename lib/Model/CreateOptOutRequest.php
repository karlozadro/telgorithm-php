...
/**
 * CreateOptOutRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateOptOutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOptOutRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['scope']) > 128)) {
            $invalidProperties[] = "invalid value for 'scope', the character length must be smaller than or equal to 128.";
        }
    ...
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling CreateOptOutRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets scope
     *
     * @param string $scope TollFree phone number (must start with country code e.g. +1...) or TCR Campaign Sid  to which end-user is opted out.
     *
     * @return self
     */
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) > 128)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling CreateOptOutRequest., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($scope) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling CreateOptOutRequest., must be bigger than or equal to 1.');
        }
