...
/**
 * CreatePhoneRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreatePhoneRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePhoneRequest';
    ...
    */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling CreatePhoneRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreatePhoneRequest., must be smaller than or equal to 64.');
        }
