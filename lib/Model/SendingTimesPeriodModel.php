...
/**
 * SendingTimesPeriodModel Class Doc Comment
 *
 * @category Class
 ...
 */
class SendingTimesPeriodModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendingTimesPeriodModel';
    ...
    */
     ...
     * Sets from
     *
     * @param string|null $from Defines time of day in a format `hh:mm:ss`, inclusive min boundary of the period.  Must be in range from zero inclusive to 1 day exclusive.  The extent of the period cannot be less than 15 minutes or greater than  1 day.
     *
     * @return self
     */
     ...
     * Sets to
     *
     * @param string|null $to Defines time of day in a format `hh:mm:ss`, inclusive max boundary of the period.  Must be greater than `from` except the last period in a day - for it `to` may be less than `from`  and is interpreted as the time period crossing the midnight.  The extent of the period cannot be less than 15 minutes or greater than  1 day.
     *
     * @return self
     */
