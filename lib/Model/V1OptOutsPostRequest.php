...
/**
 * V1OptOutsPostRequest Class Doc Comment
 *
 * @category Class
 * @description Opt outs request.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class V1OptOutsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_OptOuts_post_request';
    ...
    protected static $openAPITypes = [
        'items' => '\OpenAPI\Client\Model\CreateOptOutRequest[]'
    ];
    ...
    */
     ...
     * Gets items
     *
     * @return \OpenAPI\Client\Model\CreateOptOutRequest[]
     */
     ...
     * Sets items
     *
     * @param \OpenAPI\Client\Model\CreateOptOutRequest[] $items Opt outs to create.
     *
     * @return self
     */
    public function setItems($items)
    {
        ...
        if ((count($items) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling V1OptOutsPostRequest., number of items must be less than or equal to 2000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling V1OptOutsPostRequest., number of items must be greater than or equal to 1.');
        }
