...
/**
 * WebhookSubscriptionListModel Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookSubscriptionListModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookSubscriptionListModel';
    ...
    protected static $openAPITypes = [
        'webhook_subscriptions' => '\OpenAPI\Client\Model\WebhookSubscriptionModel[]'
    ];
    ...
    protected static $setters = [
        'webhook_subscriptions' => 'setWebhookSubscriptions'
    ];
    ...
    protected static $getters = [
        'webhook_subscriptions' => 'getWebhookSubscriptions'
    ];
    ...
    {
        $this->setIfExists('webhook_subscriptions', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets webhook_subscriptions
     *
     * @return \OpenAPI\Client\Model\WebhookSubscriptionModel[]|null
     */
    public function getWebhookSubscriptions()
    {
        return $this->container['webhook_subscriptions'];
    }

    /**
     * Sets webhook_subscriptions
     *
     * @param \OpenAPI\Client\Model\WebhookSubscriptionModel[]|null $webhook_subscriptions List of webhook subscriptions according to your filter query.
     *
     * @return self
     */
    public function setWebhookSubscriptions($webhook_subscriptions)
    {
        if (is_null($webhook_subscriptions)) {
            throw new \InvalidArgumentException('non-nullable webhook_subscriptions cannot be null');
        }
        $this->container['webhook_subscriptions'] = $webhook_subscriptions;
