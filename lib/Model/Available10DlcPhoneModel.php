...
/**
 * Available10DlcPhoneModel Class Doc Comment
 *
 * @category Class
 ...
 */
class Available10DlcPhoneModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Available10DlcPhoneModel';
    ...
    */
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Available10DlcPhoneModel., must be bigger than or equal to 1.');
        }
    ...
    public function setState($state)
    {
        ...
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Available10DlcPhoneModel., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state) < 1)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Available10DlcPhoneModel., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string $supported_services SMS, MMS, SMSMMS.
     *
     * @return self
     * @deprecated
     */
    public function setSupportedServices($supported_services)
    {
        ...
        if ((mb_strlen($supported_services) < 1)) {
            throw new \InvalidArgumentException('invalid length for $supported_services when calling Available10DlcPhoneModel., must be bigger than or equal to 1.');
        }
