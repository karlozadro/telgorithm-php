...
/**
 * WebhookSubscriptionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookSubscriptionRequest';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookSubscriptionRequest., must be smaller than or equal to 512.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookSubscriptionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthorizationBearer($authorization_bearer)
    {
        ...
        if (!is_null($authorization_bearer) && (mb_strlen($authorization_bearer) > 256)) {
            throw new \InvalidArgumentException('invalid length for $authorization_bearer when calling WebhookSubscriptionRequest., must be smaller than or equal to 256.');
        }
