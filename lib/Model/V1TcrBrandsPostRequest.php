...
/**
 * V1TcrBrandsPostRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1TcrBrandsPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_TcrBrands_post_request';
    ...
    */
     ...
     * Sets tcr_brand_id
     *
     * @param string $tcr_brand_id Brand TCR ID. Should be exactly as shown in TCR.
     *
     * @return self
     */
    public function setTcrBrandId($tcr_brand_id)
    {
        ...
        if ((mb_strlen($tcr_brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tcr_brand_id when calling V1TcrBrandsPostRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name TCR Brand Name. Should be legal company name exactly as shown in TCR.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V1TcrBrandsPostRequest., must be bigger than or equal to 1.');
        }
