...
/**
 * OptOutsRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class OptOutsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptOutsRequest';
    ...
    */
    ...
    public function setItems($items)
    {
        ...
        if ((count($items) > 2000)) {
            throw new \InvalidArgumentException('invalid value for $items when calling OptOutsRequest., number of items must be less than or equal to 2000.');
        }
        if ((count($items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $items when calling OptOutsRequest., number of items must be greater than or equal to 1.');
        }
