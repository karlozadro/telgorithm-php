...
/**
 * PortInRequestData Class Doc Comment
 *
 * @category Class
 * @description Porting phones data
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PortInRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PortInRequest_data';
    ...
    protected static $openAPITypes = [
        'phones' => '\OpenAPI\Client\Model\PortInPhone[]',
        'features' => '\OpenAPI\Client\Model\PortInPhoneFeatures'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phones']) && (count($this->container['phones']) > 100)) {
            $invalidProperties[] = "invalid value for 'phones', number of items must be less than or equal to 100.";
        }
     ...
     * Gets phones
     *
     * @return \OpenAPI\Client\Model\PortInPhone[]|null
     */
     ...
     * Sets phones
     *
     * @param \OpenAPI\Client\Model\PortInPhone[]|null $phones Phones collection to port in.  <br />  Max number of numbers provider can validate synchronously is 100.
     *
     * @return self
     */
    public function setPhones($phones)
    {
        ...
        if ((count($phones) > 100)) {
            throw new \InvalidArgumentException('invalid value for $phones when calling PortInRequestData., number of items must be less than or equal to 100.');
        }
        if ((count($phones) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phones when calling PortInRequestData., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets features
     *
     * @return \OpenAPI\Client\Model\PortInPhoneFeatures
     */
     ...
     * Sets features
     *
     * @param \OpenAPI\Client\Model\PortInPhoneFeatures $features features
     *
     * @return self
     */
