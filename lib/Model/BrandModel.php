 ...
 */
class BrandModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BrandModel';
    ...
    */
     ...
     * Sets tcr_brand_id
     *
     * @param string $tcr_brand_id TCR Brand ID.
     *
     * @return self
     */
    public function setTcrBrandId($tcr_brand_id)
    {
        ...
        if ((mb_strlen($tcr_brand_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tcr_brand_id when calling BrandModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name TCR Brand Name.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BrandModel., must be bigger than or equal to 1.');
        }
