...
/**
 * TimeZoneModel Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TimeZoneModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeZoneModel';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TimeZoneModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets name
     *
     * @param string $name Specifies the display name of the time zone.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TimeZoneModel., must be bigger than or equal to 1.');
        }
