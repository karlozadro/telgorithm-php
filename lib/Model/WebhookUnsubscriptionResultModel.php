...
/**
 * WebhookUnsubscriptionResultModel Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookUnsubscriptionResultModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookUnsubscriptionResultModel';
    ...
    {
        $this->setIfExists('was_removed', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['was_removed'];
    }

    /**
     * Sets was_removed
     *
     * @param bool|null $was_removed Specified whether the subscription was successfully removed or not  (i.e `true` whether the subscription existed before and `false` otherwise).
     *
     * @return self
     */
    public function setWasRemoved($was_removed)
    {
        if (is_null($was_removed)) {
            throw new \InvalidArgumentException('non-nullable was_removed cannot be null');
        }
        $this->container['was_removed'] = $was_removed;
