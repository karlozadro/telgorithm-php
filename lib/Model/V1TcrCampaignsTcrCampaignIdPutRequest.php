...
/**
 * V1TcrCampaignsTcrCampaignIdPutRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class V1TcrCampaignsTcrCampaignIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_TcrCampaigns__tcrCampaignId__put_request';
    ...
    */
    ...
    public function setCreationDate($creation_date)
    {
        ...
        if (!is_null($creation_date) && (mb_strlen($creation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $creation_date when calling V1TcrCampaignsTcrCampaignIdPutRequest., must be smaller than or equal to 10.');
        }
