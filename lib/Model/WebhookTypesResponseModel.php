...
/**
 * WebhookTypesResponseModel Class Doc Comment
 *
 * @category Class
 ...
 */
class WebhookTypesResponseModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookTypesResponseModel';
    ...
    {
        $this->setIfExists('webhook_types', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string[]|null
     */
    public function getWebhookTypes()
    {
        return $this->container['webhook_types'];
    }

    /**
     * Sets webhook_types
     *
     * @param string[]|null $webhook_types Values which can be specified for webhook type when subscribing or unsubscribing.
     *
     * @return self
     */
    public function setWebhookTypes($webhook_types)
    {
        if (is_null($webhook_types)) {
            throw new \InvalidArgumentException('non-nullable webhook_types cannot be null');
        }
        $this->container['webhook_types'] = $webhook_types;
