...
/**
 * MessagingConfigRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class MessagingConfigRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MessagingConfigRequest';
    ...
    */
    ...
    public function setInboundCallbackUrl($inbound_callback_url)
    {
        ...
        if (!is_null($inbound_callback_url) && (mb_strlen($inbound_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $inbound_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($inbound_callback_url) && (mb_strlen($inbound_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $inbound_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setInboundBackupCallbackUrl($inbound_backup_callback_url)
    {
        ...
        if (!is_null($inbound_backup_callback_url) && (mb_strlen($inbound_backup_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $inbound_backup_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($inbound_backup_callback_url) && (mb_strlen($inbound_backup_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $inbound_backup_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOutboundCallbackUrl($outbound_callback_url)
    {
        ...
        if (!is_null($outbound_callback_url) && (mb_strlen($outbound_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $outbound_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($outbound_callback_url) && (mb_strlen($outbound_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $outbound_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOutboundBackupCallbackUrl($outbound_backup_callback_url)
    {
        ...
        if (!is_null($outbound_backup_callback_url) && (mb_strlen($outbound_backup_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $outbound_backup_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($outbound_backup_callback_url) && (mb_strlen($outbound_backup_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $outbound_backup_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOptInOutCallbackUrl($opt_in_out_callback_url)
    {
        ...
        if (!is_null($opt_in_out_callback_url) && (mb_strlen($opt_in_out_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_out_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($opt_in_out_callback_url) && (mb_strlen($opt_in_out_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_out_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOptInOutBackupCallbackUrl($opt_in_out_backup_callback_url)
    {
        ...
        if (!is_null($opt_in_out_backup_callback_url) && (mb_strlen($opt_in_out_backup_callback_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_out_backup_callback_url when calling MessagingConfigRequest., must be smaller than or equal to 512.');
        }
        if (!is_null($opt_in_out_backup_callback_url) && (mb_strlen($opt_in_out_backup_callback_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $opt_in_out_backup_callback_url when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTcrCampaignId($tcr_campaign_id)
    {
        ...
        if (!is_null($tcr_campaign_id) && (mb_strlen($tcr_campaign_id) > 128)) {
            throw new \InvalidArgumentException('invalid length for $tcr_campaign_id when calling MessagingConfigRequest., must be smaller than or equal to 128.');
        }
        if (!is_null($tcr_campaign_id) && (mb_strlen($tcr_campaign_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tcr_campaign_id when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MessagingConfigRequest., must be smaller than or equal to 64.');
        }
        if (!is_null($name) && (mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling MessagingConfigRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAuthorizationBearer($authorization_bearer)
    {
        ...
        if (!is_null($authorization_bearer) && (mb_strlen($authorization_bearer) > 256)) {
            throw new \InvalidArgumentException('invalid length for $authorization_bearer when calling MessagingConfigRequest., must be smaller than or equal to 256.');
        }
