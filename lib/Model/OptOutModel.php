 ...
 */
class OptOutModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OptOutModel';
    ...
    protected static $openAPITypes = [
        ...
        'scope' => 'string',
        'type' => 'string',
        'scope_type' => '\OpenAPI\Client\Model\OptOutType',
        'created_on' => '\DateTime'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['scope_type'] === null) {
            $invalidProperties[] = "'scope_type' can't be null";
        }
     ...
     * Sets number
     *
     * @param string $number End-user number that opted out.
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling OptOutModel., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling OptOutModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets scope
     *
     * @param string $scope Scope on that user is opting out.<br />  If `scopeType` is `SenderPhoneNumber`, this field contains Toll Free or 10DLC phone number.<br />  If `scopeType` is `TcrCampaign`, then it contains TCR Campaign Sid.
     *
     * @return self
     */
    public function setScope($scope)
    {
        ...
        if ((mb_strlen($scope) < 1)) {
            throw new \InvalidArgumentException('invalid length for $scope when calling OptOutModel., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string $type Obsolete, please use `scopeType` instead.
     *
     * @return self
     * @deprecated
     */
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling OptOutModel., must be bigger than or equal to 1.');
        }
     ...
     * Gets scope_type
     *
     * @return \OpenAPI\Client\Model\OptOutType
     */
     ...
     * Sets scope_type
     *
     * @param \OpenAPI\Client\Model\OptOutType $scope_type scope_type
     *
     * @return self
     */
