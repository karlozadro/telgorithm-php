...
/**
 * CampaignPatchRequest Class Doc Comment
 *
 * @category Class
 * @description 
 * @package  OpenAPI\Client
 ...
 */
class CampaignPatchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignPatchRequest';
    ...
    */
    ...
    public function setCreationDate($creation_date)
    {
        ...
        if (!is_null($creation_date) && (mb_strlen($creation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $creation_date when calling CampaignPatchRequest., must be smaller than or equal to 10.');
        }
