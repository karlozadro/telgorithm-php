...
/**
 * V1MyCompanyCspIdPutRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class V1MyCompanyCspIdPutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_v1_MyCompany_cspId_put_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['csp_id']) && !preg_match("/S[0-9A-Z]{6,127}/", $this->container['csp_id'])) {
            $invalidProperties[] = "invalid value for 'csp_id', must be conform to the pattern /S[0-9A-Z]{6,127}/.";
        }
     ...
     * Sets csp_id
     *
     * @param string|null $csp_id CSP ID, it should be 7+ char upper alphanumeric identity prefixed with the letter 'S'.
     *
     * @return self
     */
    public function setCspId($csp_id)
    {
        ...
        if (!is_null($csp_id) && (!preg_match("/S[0-9A-Z]{6,127}/", $csp_id))) {
            throw new \InvalidArgumentException("invalid value for \$csp_id when calling V1MyCompanyCspIdPutRequest., must conform to the pattern /S[0-9A-Z]{6,127}/.");
        }
